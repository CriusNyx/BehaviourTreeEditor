...
namespace NodeEditorFramework
{
    ...
    public abstract class NodeCanvas : ScriptableObject
    {
        ...
        /// </summary>
        public static T CreateCanvas<T>(bool edit = false) where T : NodeCanvas
        {
        ...
        public void FillContextMenu(Action<NodeEditorInputInfo, GenericMenu, ContextType> fillDefaultContextMenu, NodeEditorInputInfo inputInfo, GenericMenu contextMenu, ContextType contextType)
        {
            switch(contextType)
            {
                case ContextType.Canvas:
                    FillContextMenuCanvas(fillDefaultContextMenu, inputInfo, contextMenu, contextType);
                    break;
                case ContextType.Node:
                    FillContextMenuNode(fillDefaultContextMenu, inputInfo, contextMenu, contextType);
                    break;
                case ContextType.Toolbar:
                    FillContextMenuToolbar(fillDefaultContextMenu, inputInfo, contextMenu, contextType);
                    break;
                default:
                    fillDefaultContextMenu(inputInfo, contextMenu, contextType);
                    break;
            }
        }

        protected virtual void FillContextMenuNode(Action<NodeEditorInputInfo, GenericMenu, ContextType> fillDefaultContextMenu, NodeEditorInputInfo inputInfo, GenericMenu contextMenu, ContextType contextType)
        {
            fillDefaultContextMenu(inputInfo, contextMenu, contextType);
        }

        protected virtual void FillContextMenuCanvas(Action<NodeEditorInputInfo, GenericMenu, ContextType> fillDefaultContextMenu, NodeEditorInputInfo inputInfo, GenericMenu contextMenu, ContextType contextType)
        {
            fillDefaultContextMenu(inputInfo, contextMenu, contextType);
        }

        protected virtual void FillContextMenuToolbar(Action<NodeEditorInputInfo, GenericMenu, ContextType> fillDefaultContextMenu, NodeEditorInputInfo inputInfo, GenericMenu contextMenu, ContextType contextType)
        {
            fillDefaultContextMenu(inputInfo, contextMenu, contextType);
        }
    }
