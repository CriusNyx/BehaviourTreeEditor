...
namespace NodeEditorFramework 
{
	...
	public static class NodeEditorInputSystem
	{
		...
		private static void FillContextMenu (NodeEditorInputInfo inputInfo, GenericMenu contextMenu, ContextType contextType) 
		{
            ...
            if(inputInfo != null && inputInfo.editorState != null && inputInfo.editorState.canvas != null)
            {
                inputInfo.editorState.canvas.FillContextMenu(DefaultFillContextMenu, inputInfo, contextMenu, contextType);
            }
            else
            {
                DefaultFillContextMenu(inputInfo, contextMenu, contextType);
            }
        }

        private static void DefaultFillContextMenu(NodeEditorInputInfo inputInfo, GenericMenu contextMenu, ContextType contextType)
        {
